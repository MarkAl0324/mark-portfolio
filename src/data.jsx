...
const PORTFOLIO = {
  ...
  projects: [
    ...
    },
    {
      ...
      desc: "Daily transaction coordination for a San Diego brokerage: deadlines, disclosures and document flow from contract to close, backed by a purpose-built Claude skill suite.",
    },
    {
      num: "06",
      featured: false,
      ...
      desc: "A Claude-based workflow that monitors transaction status, surfaces missing documents and flags deadline risk across active files. It cut manual status checks by about 50%, roughly 1.5 hours a day.",
